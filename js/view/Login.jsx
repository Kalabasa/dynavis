			...
			if(this.model().isNew()) {
				return (
					<div className="login clearfix">
						<form onSubmit={this.handle_login}>
							...
							<input className="button-login pull-right pure-button pure-button-primary" type="submit" value="Login" />
						</form>
					</div>
				);
			}else{
				return (
					<div className="login clearfix">
						...
						<button className="button-logout pull-right pure-button btn-sm" onClick={this.handle_logout}>Logout</button>
					</div>
				);
			}
		},
